    ...
    thread::spawn(move || {
        ...
        'outer: loop {
            ...
            if !bad_state {
                ...
                bad_state =
                    SPRunner::bad_state(runner.state(), &runner.transition_system_models[0]);
            }
            ...
            for (i, (ts, goals)) in ts_models.iter().zip(goals.iter()).enumerate().rev() {
                    ...
                    != &true.to_spvalue()
                {
                    ...
                    runner.input(SPRunnerInput::NewPlan(
                        i as i32,
                        SPPlan {
                ...
                let replan = {
                    ...
                    if i == 1 && !ok {
                        let active_effects = runner.replan_specs.iter().any(|t| {
