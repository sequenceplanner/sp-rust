...
def generate_launch_description():
     package_prefix = get_package_share_directory('cubes')
     ...
     rviz_config_file = os.path.join(get_package_share_directory('cubes'),
                        'config', 'cubes.rviz')
     ...
     return LaunchDescription([
          ...
          IncludeLaunchDescription(
               PythonLaunchDescriptionSource([package_prefix, '/launch/meca_1.launch.py']),
          ...
          # robot2
          IncludeLaunchDescription(
               PythonLaunchDescriptionSource([package_prefix, '/launch/meca_2.launch.py']),
          ...
          # cube1
          #IncludeLaunchDescription(
          #     PythonLaunchDescriptionSource([package_prefix, '/launch/cube_1.launch.py']),
