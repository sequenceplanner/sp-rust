...
fn main() {
    ...
    Z3_params_set_uint(ctx, params, Z3_mk_string_symbol(ctx, CString::new(":xform.unfold_rules").unwrap().as_ptr()), 5);
    ...
    // println!("{:?}", CStr::from_ptr(Z3_fixedpoint_to_string(ctx, dl, 3, [])));
