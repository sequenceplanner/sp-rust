...
class {{ capitalized_resource_name }}Emulator(Node):
    ...
    def __init__(self):
        ...
        simple_door_example = {
            'model_type' : 'unification_1',
            'package_name' : 'simple_door_example',
            'variables' : {
                'command' : {
                    'closed' : False,
                    'opened' : False
        ...
        self.abilities = [
            'open' : {
                'transitions' : {
                    'enabled' : {
                        'guard' : [
                            simple_door_example['variables']['command']['opened'] == False,
                            simple_door_example['variables']['measured']['opened'] == False
                        ],
                        'actions' : [
                            simple_door_example['variables']['command']['opened'] = True
                        ],
                        'effects' : {
                            'nominal' : {
                                'effect' : [
                    ...
                    'executing' : {
                        ...
                        'effects' : {
                            'nominal' : {
                                'effect' : [
                                    simple_door_example['variables']['measured']['opened'] = True
                                ],
                                'probability' : 1.0
                            }
                        }
